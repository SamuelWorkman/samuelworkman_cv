...
position_data <- position_data %>% 
  ...
  mutate(
    ...
    section = case_when(
      ...
      section %in% c('tds', 'interview', 'certificate') ~ 'popular',
...
* Languages: $R$ <!--`r fontawesome::fa("r-project", fill = "steelblue", height = 13)`-->, $\LaTeX$, SAS, SPSS, VBA, SQL, Markdown, CSS, HTML (limited)
