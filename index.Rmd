...
Books {data-icon=book data-concise=true .page-break-after}
--------------------------------------------------------------------------------
...
Popular Writing on Data & Statistics {data-icon=rss-square data-concise=true .page-break-after}
--------------------------------------------------------------------------------

```{r}
print_section(position_data, 'medium')
```
...
Graduate Teaching {data-icon=school data-concise=true .page-break-after}
--------------------------------------------------------------------------------
