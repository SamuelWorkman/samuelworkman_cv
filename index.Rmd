...
CV_PDF_LOC <- "https://github.com/SamuelWorkman/samuelworkman_cv/raw/master/samuelworkman_cv.pdf"
CV_HTML_LOC <- "samuelworkman.org/cv/"
...
![logo](img/news_small.jpg){width=100%}
...
[get my book](https://www.amazon.com/Samuel-Workman/e/B01353W7UE){#skills}
--------------------------------------------------------------------------------
![](img/bookcover.jpg){width=150px}
...
---------
```{r}
print_text_block(text_blocks, 'disclaim')
```
